...
<body>
	...
	<div class="col-md-6 well">
		<h3 class="text-primary">Track your shipment Admin</h3>
		<hr style="border-top:1px dotted #ccc;"/>
		<div class="col-md-1"></div>
		<div class="col-md-10">
			<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#form_modal">Add Content</button>
			<a href="view/view.php"><button type="button" class="btn btn-primary" >view Content</button></a>
			<a href="../../../index.html"><button type="button" class="btn btn-primary" >Accueil page</button></a>
